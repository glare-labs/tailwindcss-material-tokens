...
export type TElevationProviderConstructor = {
...
export class ElevationProvider implements IProvider {
    ...
    constructor(params: TElevationProviderConstructor) {
 ...
 * ```
 */
export const provideElevation = (params: TElevationProviderConstructor = {
