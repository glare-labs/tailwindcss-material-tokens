...
export type TTypographyProviderConstructor = {
...
export class TypographyProvider implements IProvider {
    ...
    constructor(params: TTypographyProviderConstructor) {
...
export const provideTypography = (param: TTypographyProviderConstructor = {
